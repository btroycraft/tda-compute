...
/* BoundaryOperator*
createBoundaryOperator(BoundaryOperator* boundaryOperator){
	
	return memcpy(malloc(sizeof(BoundaryOperator)), boundaryOperator, sizeof(BoundaryOperator));
} */
...
/*void
deleteBoundaryOperator(BoundaryOperator* boundaryOperator){
	
	free(boundaryOperator);
